Here's your complete end-to-end app.js with Deepgram Nova-2 integration. This preserves ALL your existing features and adds the state-of-the-art transcription:
<artifact identifier="complete-deepgram-app" type="application/vnd.ant.code" language="javascript" title="Complete app.js with Deepgram Nova-2">
/* ========================================================================== */
...
function renderMarkdownLite(md) {
  ...
  const processedParts = parts.map((part, i) => {
    if (i % 2 === 1) {
      ...
      return `<pre><code class="language-lang">{lang}">
lang">{escapedCode}</code></pre>`;
    }
    let s = part;
  ...
  try {
    ...
    if (data.type === "Results") {
      ...
      if (isFinal) {
        ...
        // Update interim entry (word-by-word display)
        if (currentInterimEntry) {
